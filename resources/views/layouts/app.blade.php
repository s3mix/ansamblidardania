...
<body>
  <header class="header">
    <div class="container header__inner">
      ...
      {{-- CENTER title (mobile only; CSS controls visibility) --}}
      <div class="header__title">{{ config('dardania.business_name', 'Ansambli Dardania') }}</div>
      ...
      {{-- MENU --}}
      <nav id="navMenu" class="nav" aria-label="Main navigation">
        <div class="socials">
